<html>
<head>
    <title>Добавление функции/макроса в личную книгу макросов</title>
</head>
    <body>
        <h3>Как добавить функцию или макрос в личную книгу макросов</h3>
        <p>Функцию/макрос добавляют в личную книгу макросов с целью общего доступа к ней из разных Excel-файлов.</p>
        <ol>
            ...
            <img src="./img/personal_example.png" />            
